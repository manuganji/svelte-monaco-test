...
<header class="flex justify-between">
	...
	<nav class="flex justify-center">
		...
		<ul>
			<li class:text-white={$page.url.pathname === '/'}><a sveltekit:prefetch href="/">Home</a></li>
			<li class:text-white={$page.url.pathname === '/about'}>
				<a sveltekit:prefetch href="/about">About</a>
			</li>
			<li class:text-white={$page.url.pathname === '/todos'}>
...
<style>
	nav {
		...
		--background: rgba(145, 108, 108, 0.702);
	}
